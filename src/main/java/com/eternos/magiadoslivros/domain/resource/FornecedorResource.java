...
public class FornecedorResource {
    ...
    public Fornecedor atualizarFornecedor(@Validated @PathVariable("id") Integer id, @RequestBody FornecedorRequest fornecedorRequest){
        return fornecedorService.atualizarFornecedor(id, fornecedorRequest);
    }
}
